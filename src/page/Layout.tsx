          ...
          <div className="flex flex-grow">
            <div className="w-1/5 min-w-56 xl:block hidden border-r border-gray-300 bg-sky-200">
              ...
              <div className="absolute bottom-2 left-2">
                <span className="[&>svg]:h-5 [&>svg]:w-5 cursor-pointer" onClick={() => window.open("https://github.com/openapp-dev/openapp")}>
                  <svg
                ...
                <span className="text-xs">OpenAPP version 0.1.0</span>
              </div>
            </div>
