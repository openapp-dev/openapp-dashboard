...
import { Divider, Drawer, Menu } from "react-daisyui";
import {
  MdApps,
  MdAutoAwesomeMosaic,
  MdAutoAwesomeMotion,
        ...
        <div className="flex flex-col h-screen">
          <div className="flex flex-grow">
            <div className="w-1/5 min-w-56 xl:block hidden border-r border-gray-300 bg-sky-200">
              <OpenAppMenu />
              <div className="absolute bottom-2 left-2 flex flex-grow">
                  <span
                    className="[&>svg]:h-5 [&>svg]:w-5 px-2 py-2 bg-white cursor-pointer border rounded-md hover:bg-gray-100"
                    onClick={() => window.open("https://github.com/openapp-dev/openapp")}
                  >
                    <svg
                ...
                <span className="text-xs ml-1 py-2.5">OpenAPP version: v0.1.0</span>
              </div>
            </div>
